...
export const experience: Role[] = [
  {
    ...
    summary:
      "Sole QA owner for four AI products across the agriculture and healthcare domains, supporting 1–2 releases per product each month on independent release cycles.",
    bullets: [],
    source: "both",
    projects: [
      {
...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    context:
      "Across the agriculture and healthcare domains, supporting 1–2 releases per product each month on independent release cycles.",
  ...
  },
  {
    id: "release-cadence",
    group: "leadership",
    title: "Supported 1–2 releases per product each month",
    context: "On independent release cycles across four products.",
    metric: { value: 2, prefix: "1–", label: "Releases per product each month" },
    source: "resume",
  },
  {
    id: "cgpa",
